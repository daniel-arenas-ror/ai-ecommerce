...
export const requestOTP = (login: string, company_id: number | undefined): Promise<void> => {
  return connector.post(`/api/v1/auth/request_otp`, { login, company_id }) as Promise<void>;
}
